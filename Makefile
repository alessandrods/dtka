...
CFLAGS= $(DEBUG_FLAG) -fmessage-length=0 -Werror
...
LIBS=$(AL_BP_DIR)/libal_bp_vDTN2.a -ldtnapi -lpthread -lssl -lcrypto
...
LIBS=$(AL_BP_DIR)/libal_bp_vION.a -lbp -lici -lpthread -lssl -lcrypto 
...
LIBS=$(AL_BP_DIR)/libal_bp_vIBRDTN.a -librcommon -librdtn -lz -lpthread -lssl -lcrypto
...
LIBS=$(AL_BP_DIR)/libal_bp_vDTN2+ION.a -ldtnapi -lbp -lici -lpthread -lssl -lcrypto
...
IBRDTN_VERSION=1.0.1
INC=-I$(AL_BP_DIR)/src/bp_implementations -I$(AL_BP_DIR)/src -I$(DTN2_DIR) -I$(DTN2_DIR)/applib
LIBS=$(AL_BP_DIR)/libal_bp_vDTN2+IBRDTN.a -ldtnapi -librcommon -librdtn -lz -lpthread -lssl -lcrypto
...
LIBS=$(AL_BP_DIR)/libal_bp_vION+IBRDTN.a -lbp -lici -librcommon -librdtn -lz -lpthread -lssl -lcrypto
...
LIBS=$(AL_BP_DIR)/libal_bp.a -ldtnapi -lbp -lici -librcommon -librdtn -lz -lpthread -lssl -lcrypto
BIN_NAME=$(BIN_NAME_BASE)
endif

bin: 
	$(CC) $(INC) $(CFLAGS) -c ./src/*.c src/zfec/*.c  
