...
int sl_hash_message_text(const char *input, char *output, enum hash_type type){
	...
	i = sl_hash_message_hex(input,temp,type);
	if(i < 0)
	   return i;
...
int sl_read_DSA_key_from_file(const char* filename,int dsa_key_type,DSA *dsa){
...
int sl_write_DSA_key_to_file(DSA *dsa,const char *filename,int key_type,int format){
...
int sl_write_RSA_key_to_file(RSA *rsa,const char *filename,int key_type,int format){
...
int sl_write_DSA_key_to_mem(DSA *dsa,unsigned char *buffer,int key_type, int format){
...
int sl_write_RSA_key_to_mem(RSA *rsa,unsigned char *buffer,int key_type,int format){
...
int sl_read_DSA_key_from_mem(DSA *dsa,char *buffer,int key_type,int format){
...
int sl_read_RSA_key_from_mem(RSA *rsa,char *buffer,int key_type,int format){
